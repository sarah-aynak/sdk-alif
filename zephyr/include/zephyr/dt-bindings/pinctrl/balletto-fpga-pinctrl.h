...
#define	PIN_P0_7__ANA_S7		PINMUX_PIN(PIN_P0_7, 6)
...
#define	PIN_P1_3__OSPI0_D3_A		PINMUX_PIN(PIN_P1_3, 1)
#define	PIN_P1_3__LPPDM_C1_A		PINMUX_PIN(PIN_P1_3, 2)
#define	PIN_P1_3__LPI2S_WS_B		PINMUX_PIN(PIN_P1_3, 3)
#define	PIN_P1_3__LPSPI_MISO_A		PINMUX_PIN(PIN_P1_3, 4)
#define	PIN_P1_3__LPCAM_D3_A		PINMUX_PIN(PIN_P1_3, 5)
#define	PIN_P1_3__SD_D3_A		PINMUX_PIN(PIN_P1_3, 6)
#define	PIN_P1_3__CX_MWS_SF1		PINMUX_PIN(PIN_P1_3, 7)

#define	PIN_P1_4			12
#define	PIN_P1_4__GPIO			PINMUX_PIN(PIN_P1_4, 0)
#define	PIN_P1_4__OSPI0_D4_A		PINMUX_PIN(PIN_P1_4, 1)
#define	PIN_P1_4__LPPDM_C2_A		PINMUX_PIN(PIN_P1_4, 2)
#define	PIN_P1_4__I2S0_SDI_A		PINMUX_PIN(PIN_P1_4, 3)
#define	PIN_P1_4__LPSPI_MOSI_A		PINMUX_PIN(PIN_P1_4, 4)
#define	PIN_P1_4__LPCAM_D4_A		PINMUX_PIN(PIN_P1_4, 5)
#define	PIN_P1_4__SD_D4_A		PINMUX_PIN(PIN_P1_4, 6)
#define	PIN_P1_4__CDC_PCLK_A		PINMUX_PIN(PIN_P1_4, 7)

#define	PIN_P1_5			13
#define	PIN_P1_5__GPIO			PINMUX_PIN(PIN_P1_5, 0)
#define	PIN_P1_5__OSPI0_D5_A		PINMUX_PIN(PIN_P1_5, 1)
#define	PIN_P1_5__LPPDM_D2_A		PINMUX_PIN(PIN_P1_5, 2)
#define	PIN_P1_5__I2S0_SDO_A		PINMUX_PIN(PIN_P1_5, 3)
#define	PIN_P1_5__LPSPI_SCLK_A		PINMUX_PIN(PIN_P1_5, 4)
#define	PIN_P1_5__LPCAM_D5_A		PINMUX_PIN(PIN_P1_5, 5)
#define	PIN_P1_5__SD_D5_A		PINMUX_PIN(PIN_P1_5, 6)
#define	PIN_P1_5__CDC_DE_A		PINMUX_PIN(PIN_P1_5, 7)
...
#define	PIN_P2_0__UT0_T0_A		PINMUX_PIN(PIN_P2_0, 5)
...
#define	PIN_P7_4__BLE_DBG28		PINMUX_PIN(PIN_P7_4, 6)
...
#define	PIN_P7_5__BLE_DBG29		PINMUX_PIN(PIN_P7_5, 6)
...
#define	PIN_P7_6__BLE_DBG30		PINMUX_PIN(PIN_P7_6, 6)
...
#define	PIN_P7_7__BLE_DBG31		PINMUX_PIN(PIN_P7_7, 6)
...
#define	PIN_P9_1__SEUART_TX_C		PINMUX_PIN(PIN_P9_1, 1)
#define	PIN_P9_1__LPUART_TX_C		PINMUX_PIN(PIN_P9_1, 2)
#define	PIN_P9_1__LPI2S_SDO_C		PINMUX_PIN(PIN_P9_1, 3)
#define	PIN_P9_1__SPI1_SS2_C		PINMUX_PIN(PIN_P9_1, 4)
#define	PIN_P9_1__FAULT1_C		PINMUX_PIN(PIN_P9_1, 5)
#define	PIN_P9_1__LPCAM_D1_C		PINMUX_PIN(PIN_P9_1, 6)
#define	PIN_P9_1__SD_D1_C		PINMUX_PIN(PIN_P9_1, 7)
